...
import Project1 from "../../src/sc/d.png";
import Project2 from "../../src/sc/d1.png";
import Project3 from "../../src/sc/d2.png";
import Project4 from "../../src/sc/e4.png";
const Doctor = () => {
  return (
    <div>
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="flex flex-col gap-12 lg:flex-row view__more__btn d__flex align__items__center justify__content__center pxy__30">
                  <a href="https://acinment-1afa0.web.app/">
                    <button className="mt-5 mb-5 btn btn-secondary ">
                      Live Link
                    </button>
                  </a>
                  <a href="https://github.com/RiyadMia/Acinment-10">
                    <button className="mt-5 mb-5 btn btn-secondary ">
                      Code Link
                    </button>
                  </a>
